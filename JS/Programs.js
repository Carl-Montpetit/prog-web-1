...
// allow to drop the program to window
function allowDrop(ev) {
    ev.preventDefault();
}

//allow to drag the program to window
function drag(ev) {
    ev.dataTransfer.setData("text", ev.target.id);
}

// dropping program to window
function drop(ev) {
...
// event to drop program in window
